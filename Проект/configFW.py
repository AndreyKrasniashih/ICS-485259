...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "ЗАВДАННЯ № 10"))
        self.label.setText(_translate("Dialog", "              Меню"))
        self.pushButton.setText(_translate("Dialog", "Таблица"))
        self.pushButton_2.setText(_translate("Dialog", "Graph"))
        self.pushButton_4.setText(_translate("Dialog", "Вийти"))
        self.label_4.setText(_translate("Dialog", "Автор:Краснящих Андрій ФІТ (1-7)"))
        self.pushButton_3.setText(_translate("Dialog", "ФИТ 1-7"))
